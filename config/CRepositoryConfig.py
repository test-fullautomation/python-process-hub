...
# *******************************************************************************
#
# File: CRepositoryConfig.py
#
# Initially created by Nguyen Huynh Tri Cuong (MS/EMC51) / January 2026.
#
# Description:
#   Repository configuration class for ProcessHub.
#   Computes and stores all repository specific information.
#
# History:
#
...
class CRepositoryConfig():
    ...
    def __InitConfig(self):
        ...
        # ---- paths relative to repository root folder
