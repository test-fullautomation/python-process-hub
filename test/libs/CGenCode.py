...
class CGenCode():
   ...
   def GenCode(self):
      ...
      PYTESTLISTFILE_RST = f"{REFERENCEPATH}/PHB_TestUsecases.rst"
      oPyTestListFile_RST = CFile(PYTESTLISTFILE_RST)
      print(f"* '{PYTESTLISTFILE_RST}'")

      PYTESTLISTFILE_TXT = f"{REFERENCEPATH}/PHB_TestUsecases.txt"
      oPyTestListFile_TXT = CFile(PYTESTLISTFILE_TXT)
      print(f"* '{PYTESTLISTFILE_TXT}'")

      PYTESTLISTFILE_CSV = f"{REFERENCEPATH}/PHB_TestUsecases.csv"
      oPyTestListFile_CSV = CFile(PYTESTLISTFILE_CSV)
      print(f"* '{PYTESTLISTFILE_CSV}'")

      PYTESTLISTFILE_HTML = f"{REFERENCEPATH}/PHB_TestUsecases.html"
...
<meta http-equiv="content-type" content="text/html; charset=windows-1252">
   <meta name="ProcessHub" content="ProcessHub">
   <title>ProcessHub Test Cases</title>
</head>
...
<b>
ProcessHub Test Cases<br>
(<em>Process lifecycle management hub</em>)
</b></font>
</div>
<hr width="100%" color="#FF8C00" align="center">
...
"""
      ...
      for dictUsecase in listofdictUsecases:
         ...
         TESTFILElink   = f"https://sourcecode.socialcoding.bosch.com/projects/BITSRF/repos/python-process-hub/browse/test/testfiles/{TESTFILEname}"
